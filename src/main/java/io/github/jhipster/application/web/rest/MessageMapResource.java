...
public class MessageMapResource {
    ...
    public ResponseEntity<MessageMap> createMessageMap(@Valid @RequestBody MessageMap messageMap) throws URISyntaxException {
    ...
    public ResponseEntity<MessageMap> updateMessageMap(@Valid @RequestBody MessageMap messageMap) throws URISyntaxException {
