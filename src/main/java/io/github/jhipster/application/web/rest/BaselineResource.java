...
public class BaselineResource {
    ...
    public ResponseEntity<Baseline> createBaseline(@Valid @RequestBody Baseline baseline) throws URISyntaxException {
    ...
    public ResponseEntity<Baseline> updateBaseline(@Valid @RequestBody Baseline baseline) throws URISyntaxException {
