...
public class ModelCodeResource {
    ...
    public ResponseEntity<ModelCode> createModelCode(@Valid @RequestBody ModelCode modelCode) throws URISyntaxException {
    ...
    public ResponseEntity<ModelCode> updateModelCode(@Valid @RequestBody ModelCode modelCode) throws URISyntaxException {
