...
public class AttributeOptionResource {
    ...
    public ResponseEntity<AttributeOption> createAttributeOption(@Valid @RequestBody AttributeOption attributeOption) throws URISyntaxException {
    ...
    public ResponseEntity<AttributeOption> updateAttributeOption(@Valid @RequestBody AttributeOption attributeOption) throws URISyntaxException {
