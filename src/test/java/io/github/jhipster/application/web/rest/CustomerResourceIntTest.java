...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_CHAMPION = "AAAAAAAAAA";
    private static final String UPDATED_CHAMPION = "BBBBBBBBBB";
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getChampion()).isEqualTo(DEFAULT_CHAMPION);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].champion").value(hasItem(DEFAULT_CHAMPION.toString())))
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.champion").value(DEFAULT_CHAMPION.toString()))
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getChampion()).isEqualTo(UPDATED_CHAMPION);
