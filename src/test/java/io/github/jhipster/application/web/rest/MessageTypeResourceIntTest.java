...
public class MessageTypeResourceIntTest {
    ...
    public void checkDescriptionIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageTypeRepository.findAll().size();
        // set the field null
        messageType.setDescription(null);
    ...
    public void checkDefinitionIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageTypeRepository.findAll().size();
        // set the field null
        messageType.setDefinition(null);
    ...
    @Test
    @Transactional
    public void checkIsProductionStopIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageTypeRepository.findAll().size();
        // set the field null
        messageType.setIsProductionStop(null);
