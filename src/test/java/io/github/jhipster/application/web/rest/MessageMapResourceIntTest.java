...
public class MessageMapResourceIntTest {
    ...
    public void checkMessageIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageMapRepository.findAll().size();
        // set the field null
        messageMap.setMessage(null);

        // Create the MessageMap, which fails.
        ...
        List<MessageMap> messageMapList = messageMapRepository.findAll();
        assertThat(messageMapList).hasSize(databaseSizeBeforeTest);
    }

    @Test
    @Transactional
    public void checkBitIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageMapRepository.findAll().size();
        // set the field null
        messageMap.setBit(null);
    ...
    @Test
    @Transactional
    public void checkIoeIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageMapRepository.findAll().size();
        // set the field null
        messageMap.setIoe(null);
    ...
    @Test
    @Transactional
    public void checkCipAddressIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageMapRepository.findAll().size();
        // set the field null
        messageMap.setCipAddress(null);
