...
public class AttributeOptionResourceIntTest {
    ...
    public void checkNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = attributeOptionRepository.findAll().size();
        // set the field null
        attributeOption.setName(null);

        // Create the AttributeOption, which fails.
        ...
        List<AttributeOption> attributeOptionList = attributeOptionRepository.findAll();
        assertThat(attributeOptionList).hasSize(databaseSizeBeforeTest);
    }
