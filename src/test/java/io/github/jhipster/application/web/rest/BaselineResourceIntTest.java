...
public class BaselineResourceIntTest {
    ...
    @Test
    @Transactional
    public void checkCycleLengthIsRequired() throws Exception {
        int databaseSizeBeforeTest = baselineRepository.findAll().size();
        // set the field null
        baseline.setCycleLength(null);

        // Create the Baseline, which fails.
        ...
        List<Baseline> baselineList = baselineRepository.findAll();
        assertThat(baselineList).hasSize(databaseSizeBeforeTest);
    }

    @Test
    @Transactional
    public void checkMinToleranceIsRequired() throws Exception {
        int databaseSizeBeforeTest = baselineRepository.findAll().size();
        // set the field null
        baseline.setMinTolerance(null);
    ...
    @Test
    @Transactional
    public void checkMaxToleranceIsRequired() throws Exception {
        int databaseSizeBeforeTest = baselineRepository.findAll().size();
        // set the field null
        baseline.setMaxTolerance(null);
    ...
    @Test
    @Transactional
    public void checkMinNormalToleranceIsRequired() throws Exception {
        int databaseSizeBeforeTest = baselineRepository.findAll().size();
        // set the field null
        baseline.setMinNormalTolerance(null);
    ...
    @Test
    @Transactional
    public void checkMaxNormalToleranceIsRequired() throws Exception {
        int databaseSizeBeforeTest = baselineRepository.findAll().size();
        // set the field null
        baseline.setMaxNormalTolerance(null);
