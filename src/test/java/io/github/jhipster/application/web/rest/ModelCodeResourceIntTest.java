...
public class ModelCodeResourceIntTest {
    ...
    public void createModelCode() throws Exception {
        ...
        assertThat(testModelCode.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    public void checkNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = modelCodeRepository.findAll().size();
        // set the field null
        modelCode.setName(null);

        // Create the ModelCode, which fails.
        ...
        List<ModelCode> modelCodeList = modelCodeRepository.findAll();
        assertThat(modelCodeList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateModelCode() throws Exception {
        ...
        assertThat(testModelCode.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
